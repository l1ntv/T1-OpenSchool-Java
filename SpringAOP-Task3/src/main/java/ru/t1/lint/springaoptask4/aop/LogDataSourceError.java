package ru.t1.lint.springaoptask4.aop;
...
import ru.t1.lint.springaoptask4.kafka.KafkaDataSourceErrorProducer;
import ru.t1.lint.springaoptask4.model.DataSourceErrorLog;
import ru.t1.lint.springaoptask4.repository.DataSourceErrorLogRepository;
...
public class LogDataSourceError {
    ...
    @Pointcut("@annotation(ru.t1.lint.springaoptask4.aop.DataSourceErrorLoggable)")
